...
export const metadata: Metadata = {
  ...
  title: {
    ...
    template: `%s — Leo Ethos International`,
  },
  ...
  return (
    <html lang="en">
      <body className={fontVariables}>
        <a
          href="#main"
          className="sr-only focus:not-sr-only focus:absolute focus:top-4 focus:left-4 focus:z-[100] focus:bg-highlight focus:px-4 focus:py-2 focus:font-display focus:text-sm focus:font-bold focus:text-ink focus:uppercase"
        >
          Skip to content
        </a>
